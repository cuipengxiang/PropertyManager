...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ALAsset *alAsset = [self.assets objectAtIndex:indexPath.row];
    [cell applyData:alAsset];
    if (self.imagesHasSelected) {
        for (ALAsset *selected in self.imagesHasSelected) {
            if ([selected.defaultRepresentation.url isEqual:alAsset.defaultRepresentation.url]) {
                dispatch_async(dispatch_get_main_queue(), ^{
